  ...
  <nav class="bg-[#21070C] px-8 py-4">
    <div class="max-w-[1400px] mx-auto flex items-center justify-between">
      ...
      <div class="flex items-center gap-8">
        <RouterLink to="/flota" class="text-gray-300 hover:text-white transition-colors text-sm font-medium">
          Flota
        </RouterLink>
        <RouterLink to="/servicios" class="text-gray-300 hover:text-white transition-colors text-sm font-medium">
          Servicios
        </RouterLink>
        <RouterLink to="/contacto" class="text-gray-300 hover:text-white transition-colors text-sm font-medium">
          Contacto
        </RouterLink>
      </div>
